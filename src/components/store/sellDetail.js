...
function SellDetail() {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(`${HOST}/selling-posts/1`);
  ...
  return (
    <>
      <div className={sellStyle["imageDiv"]}>
        {" "}
        <img
      ...
      <div className={sellStyle["allDiv"]}>
        ...
        <div className={sellStyle["titleDiv"]}>
          <div className={sellStyle["information"]}>
            ...
            <div className={sellStyle["p"]}>
              <p>
                {sellingPost ? sellingPost.createdAt.split("T")[0] : "로딩중"}
              </p>
            </div>
          </div>
        ...
        <div className={sellStyle["anyDiv"]}>
          ...
          <div className={sellStyle["buttonDiv"]}>
            ...
            <button className={sellStyle["btnHeart"]}>
              {" "}
              <GoHeart />{" "}
            </button>
          </div>
